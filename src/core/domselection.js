	 ...
	 calculateDisplayObjectStyles: function() {
 		this.each(function(el) {
			...
			if(obj.data('textcolor')){
				var style=selector + ', ' + selector + ' h1, ' + selector + ' h2, ' + selector + ' h3, ' + selector + ' h4, ' + selector + ' h5, ' + selector + ' h6, ' +selector + ' a:link, ' + selector + ' a:visited, '  + selector + ' a:hover, ' + selector + ' a:active { color:' + obj.data('textcolor') + ';} ';
				sheet.insertRule(
					style,
					sheet.cssRules.length
				);
				...
				if(metaWrapper.length){
					...
					if(meta.length){
						...
						if(obj.data('metatextcolor')){
							...
							var style = selector + ', ' + selector + ' h1, ' + selector + ' h2, ' + selector + ' h3, ' + selector + ' h4, ' + selector + ' h5, ' + selector + ' h6, ' +selector + ' a:link, ' + selector + ' a:visited, '  + selector + ' a:hover, ' + selector + ' a:active { color:' + obj.data('metatextcolor') + ';} ';
							sheet.insertRule(
								style,
								sheet.cssRules.length
							);
			...
			if(obj.data('contenttextcolor')){
				...
				var style=	selector + ', ' + selector + ' h1, ' + selector + ' h2, ' + selector + ' h3, ' + selector + ' h4, ' + selector + ' h5, ' + selector + ' h6, ' +selector + ' a:link, ' + selector + ' a:visited, '  + selector + ' a:hover, ' + selector + ' a:active { color:' + obj.data('contenttextcolor') + ';} ';
				sheet.insertRule(
				style,
					sheet.cssRules.length
				);
